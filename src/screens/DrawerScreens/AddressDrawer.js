...
//                                             {item.farmerName || `${user.firstName} ${user.lastName}` || 'N/A'}
//                                         </Text>
...
//                                             <Text>+91 {item.farmerPhone || user.phoneNumber }</Text>
//                                         </View>
//                                     ) : null}
...
//                                         <Text>{item.district || 'N/A'}, {location.state || 'N/A'} - {item.pincode || 'N/A'}</Text>
//                                     </View>
//                                 </View>
//                             </TouchableOpacity>
//                         ))
...
export default function AddressDrawer() {
  ...
  const isAddressAvailable = location.state && location.district && location.block;
  ...
  return (
    <View style={styles.container}>
      {isAddressAvailable ? (
        ...
        <Text style={styles.noAddress}>No address available. Please add one.</Text>
      )}
    </View>
  );
}
